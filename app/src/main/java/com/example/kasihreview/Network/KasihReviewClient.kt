...
//    }
    ...
    suspend fun postMovieGoer(user: MovieGoer): Result<MovieGoerDTO, Error> {
        val response = try {
            client.post("http://34.101.157.86:8080/api/moviegoers") {
                contentType(ContentType.Application.Json)
                setBody(user)
            }
    ...
    suspend fun postReview(
        ...
        val response = try {
            client.post("http://34.101.157.86:8080/api/reviews") {
                contentType(ContentType.Application.Json)
    ...
    suspend fun postMovie(movie: MoviesDTO): Result<MoviesDTO, NetworkError> {
        ...
        val response = try {
            client.post("http://34.101.157.86:8080/api/movies") {
                contentType(ContentType.Application.Json)
                setBody(movie)
            }
        }catch(e: UnresolvedAddressException) {
...
//    }
    ...
    suspend fun loginAuth(
        ...
        val response = try {
            client.post("http://34.101.157.86:8080/api/moviegoers/login") {
                contentType(ContentType.Application.Json)
                setBody(LoginRequest(username, password))
            }
        } catch (e: UnresolvedAddressException) {
    ...
    suspend fun getReviewByMovieGoerId(id: Int): Result<List<ReviewResponse>, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/reviews/user/$id")
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
        } catch(e: SerializationException) {
            return Result.Error(NetworkError.SERIALIZATION)
    ...
    suspend fun getReviewById(id: Int): Result<ReviewResponse, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/reviews/$id")
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
        } catch(e: SerializationException) {
            return Result.Error(NetworkError.SERIALIZATION)
    ...
    suspend fun getMovieGoerById(id: Int): Result<MovieGoerDTO, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/moviegoers/$id")
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
        } catch(e: SerializationException) {
            return Result.Error(NetworkError.SERIALIZATION)
    ...
    suspend fun getReviewByMovieId(id: Int): Result<List<ReviewResponse>, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/movies/$id/reviews")
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
        } catch(e: SerializationException) {
            return Result.Error(NetworkError.SERIALIZATION)
    ...
    suspend fun postMovieToWatchList(userId: Int, movieId: Int): Result<WatchlistDTO, NetworkError> {
        val response = try {
            client.post("http://34.101.157.86:8080/api/watchlist/user/$userId/movie/$movieId") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun postReviewVote(reviewVote: VoteRequestDTO, reviewId: Int): Result<String, NetworkError> {
        val response = try {
            client.post("http://34.101.157.86:8080/api/reviews/$reviewId/vote") {
                contentType(ContentType.Application.Json)
                setBody(reviewVote)
            }
        }catch(e: UnresolvedAddressException) {
    ...
    suspend fun getVoteByReviewId(reviewId: Int): Result<List<VoteDTO>, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/reviews/$reviewId/votes") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun getVoteByMovieGoerId(movieId: Int, movieGoerId: Int): Result<List<VoteDTO>, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/movies/$movieId/votes/moviegoer/$movieGoerId") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun patchUserVote(voteId: Int, reviewId: Int, voteType: String): Result<String, NetworkError> {
        val response = try {
            client.patch("http://34.101.157.86:8080/api/reviews/$reviewId/vote/$voteId") {
                contentType(ContentType.Application.Json)
                setBody(
                    mapOf(
    ...
    suspend fun deleteReviewVote(reviewId: Int, voteId: Int): Result<String, NetworkError> {
        val response = try {
            client.post("http://34.101.157.86:8080/api/reviews/$reviewId/vote/$voteId") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun getMovieById(id: Int): Result<Double, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/movies/avgRating/$id") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun updateUserProfile(user: MovieGoer): Result<MovieGoerDTO, NetworkError> {
        val response = try {
            client.patch("http://34.101.157.86:8080/api/moviegoers/${user.id}/profile") {
                contentType(ContentType.Application.Json)
                setBody(user)
            }
        }catch(e: UnresolvedAddressException) {
    ...
    suspend fun updateUserReviewContent(userId: Int, content: String): Result<ReviewRequestDTO, NetworkError> {
        val response = try {
            client.patch("http://34.101.157.86:8080/api/reviews/${userId}") {
                contentType(ContentType.Application.Json)
                setBody(
                    mapOf(
                        "content" to content
    ...
    suspend fun deleteMovieFromWatchList(userId: Int, movieId: Int): Result<WatchlistDTO, NetworkError> {
        val response = try {
            client.delete("http://34.101.157.86:8080/api/watchlist/user/$userId/movie/$movieId") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
    ...
    suspend fun getWatchListByUserId(userId: Int): Result<WatchlistDTO, NetworkError> {
        val response = try {
            client.get("http://34.101.157.86:8080/api/watchlist/user/$userId") {
                contentType(ContentType.Application.Json)
            }
        }catch(e: UnresolvedAddressException) {
            return Result.Error(NetworkError.NO_INTERNET)
